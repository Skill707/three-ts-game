...
import { ActiveEvents, ColliderDesc, RigidBodyDesc, type RigidBody, type World } from "@dimforge/rapier3d";
...
export default class Player {
	...
	constructor(scene: Scene, camera: PerspectiveCamera, renderer: WebGLRenderer, world: World, position: Vector3 = new Vector3()) {
		this.scene = scene;
