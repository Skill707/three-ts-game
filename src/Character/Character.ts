...
export default class Character extends Entity {
	...
	update(delta: number) {
		...
		if (this.body) this.body.applyImpulse(this.inputVelocity, true);

		// The followCam will lerp towards the followTarget position.
		if (this.body) this.followTarget.position.copy(this.body.translation()); // Copy the capsules position to followTarget
